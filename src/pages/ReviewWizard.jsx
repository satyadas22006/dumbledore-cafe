...
export default function ReviewWizard({ onComplete, onNavigate, theme, twin, setTwin }) {
  ...
  return (
    <>
      {/* Fixed, full-viewport gradient background layer — sits behind
          EVERYTHING, including the navbar in App.jsx. This works because
          the /review route's theme.bg is set to 'transparent' in App.jsx,
          and the navbar itself renders with a transparent background, so
          there's nothing opaque left to block this from showing through. */}
      <div
        className="fixed inset-0 -z-10 pointer-events-none"
        style={{ background: 'radial-gradient(circle at center, #2F241A 0%, #17100B 100%)' }}
      />
