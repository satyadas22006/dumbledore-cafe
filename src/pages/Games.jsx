...
import { ArrowLeft, Sparkles, Smile, Trophy } from 'lucide-react';
        ...
        <div className="bg-[#F9F6F0] text-[#3C2F2F] border-4 border-[#3C2F2F] rounded-[2.5rem] shadow-[8px_8px_0px_0px_#3C2F2F] p-6 md:p-10 relative overflow-hidden">
          ...
          <div className="flex justify-center mt-10">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => onNavigate('game-leaderboard')}
              className="inline-flex items-center gap-2 bg-[#FFE08A] border-2 border-[#3C2F2F] px-5 py-2.5 rounded-full font-black text-xs uppercase tracking-widest shadow-[3px_3px_0_#3C2F2F] hover:shadow-[4px_4px_0_#3C2F2F] transition-all"
            >
              <Trophy size={14} className="text-[#3C2F2F]" /> View Leaderboard
            </motion.button>
          </div>

          {/* Bottom decorative scribble badge */}
          <div className="text-center mt-8 text-[11px] font-bold uppercase tracking-widest opacity-40">
